...
3. Najdeme řádek `# %wheel ALL=(ALL:ALL) ALL` odstraníme "`#`" a smažeme mezeru. Takto: `%wheel ALL=(ALL:ALL) ALL` *= Umožnili jsme skupině wheel použivat sudo. Pod touto skupinou je náš uživatel*
4. Uložíme
