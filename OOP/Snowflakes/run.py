...
class Window:
    def __init__(self):
        ...
        # KONFIGURACE
        # KONFIGURACE
        self.img = Image.open('./OOP/Snowflakes/img/snowflake.png').convert("RGBA")
        self.screen = pygame.display.set_mode((self.width, self.height))
        self.clock = pygame.time.Clock()
        self.temp = 0
        
        # Nastavení pozadí
        self.bg_img = pygame.transform.scale(pygame.image.load('./OOP/Snowflakes/img/forest-mountain-ridge-covered-with-snow-milky-way-starry-sky-christmas-winter-night.jpg'), (self.width, self.height))
    ...
    def create_snow_flakes(self):
            ...
            if self.surprise:
                ...
                surprise.texture = pygame.transform.scale(pygame.image.load('./OOP/Snowflakes/img/suprise.png').convert_alpha(), (45, 45))
                arr.append(surprise)
